  ...
  return (
    <div className="min-h-screen flex flex-col">
      <header className="border-b border-border/60 bg-card/40 backdrop-blur-xl sticky top-0 z-40">
        <div className="mx-auto max-w-5xl xl:max-w-6xl 2xl:max-w-7xl px-3 sm:px-6 h-14 flex items-center justify-between gap-2">
      ...
      <main className="flex-1 mx-auto w-full max-w-5xl xl:max-w-6xl 2xl:max-w-7xl px-3 sm:px-6 py-4 sm:py-6">
        {children}
      </main>
