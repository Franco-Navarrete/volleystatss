...
function LiveMatch() {
  ...
  return (
    <CompactShell>
      <div className="relative flex flex-col gap-1.5 md:gap-3 h-full min-h-0 px-2 md:px-6 py-2 md:py-4 mx-auto w-full max-w-[1400px] [@media(min-width:1600px)_and_(pointer:coarse)]:max-w-[1900px] select-none">
        {/* Scoreboard header */}
